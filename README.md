...
Dataset Access
Due to large file size, the BraTS 2021 dataset is not hosted in this repository.

📦 Download it from: https://www.kaggle.com/datasets/dschettler8845/brats-2021-task1
